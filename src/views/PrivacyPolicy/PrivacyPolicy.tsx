  ...
  return (
    <div className={s.privatPolicy}>
      ...
      <p className={s.description}>
        Professional summary - A brief description & summary about you & your
        experience.
      </p>
      ...
      <p className={s.text}>
        ...
        forgot to shop for foods, the paint you may slap on your face to impress
        the new boss is your business. But what about your daily bread? Not so
        fast, I'd say, there are some redeeming factors in favor of greeking
        text, as its use is merely the symptom of a worse problem.
      </p>
        ...
        Using a grid benefits both end users and the designers alike:
        {
          <ul className={s.list}>
            <li>
              ...
              will tell in no uncertain terms that Lorem Ipsum is
            </li>
